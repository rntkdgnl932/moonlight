            ...
            if imgs_ is not None and imgs_ != False:
                ...
                if len(ran_item) != 0:
                    ...
                    for ran_list in range(sell_many):
                        ...
                        for i in range(len(read_list)):
                            full_path = "c:\\my_games\\moonlight\\data_moon\\imgs\\auction\\list\\" + read_list[
                                i] + ".PNG"
                            img_array = np.fromfile(full_path, np.uint8)
                            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                            imgs_ = imgs_set_(610, 160, 960, 1000, cla, img, 0.8)
                                            ...
                                            if this_price > 10:
                                                ...
                                                if str_price == result_equal:
                                                    for j in range(10):
                                                        ...
                                                        time.sleep(0.5)
                                                    # for j in range(10):
                                                    #     full_path = "c:\\my_games\\moonlight\\data_moon\\imgs\\auction\\self_certification.PNG"
                                                    #     img_array = np.fromfile(full_path, np.uint8)
                                                    #     img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                                                    #     imgs_ = imgs_set_(450, 500, 590, 560, cla, img, 0.8)
                                                    #     if imgs_ is not None and imgs_ != False:
                                                    #         click_pos_reg(imgs_.x, imgs_.y, cla)
                                                    #         time.sleep(0.1)
                                                    #         break
                                                ...
                                                if certification == False:
                                                    for k in range(10):
                                                        ...
                                                        if imgs_ is not None and imgs_ != False:
                                                            ...
                                                            img_array = np.fromfile(full_path, np.uint8)
                                                            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                                                            imgs_ = imgs_set_(370, 570, 440, 750, cla, img, 0.8)
                                                            if imgs_ is not None and imgs_ != False:
                                                                click_pos_reg(imgs_.x, imgs_.y, cla)
                                                        else:
                                                            for x in range(5):
