...
def game_start():
    ...
    try:
        ...
        if start_get == "yes":
            ...
            result_my_server_read = server_get_moonlight()
            ...
            if result_my_server_read == 'start':
                ...
                file_path = "C:\\my_games\\moonlight\\data_moon\\mymodule\\version.txt"
                with open(file_path, "r", encoding='utf-8-sig') as file:
...
def server_get_moonlight():
    try:
        url = "https://raw.githubusercontent.com/rntkdgnl932/server/master/moonlight.txt"

        response = requests.get(url, headers={'Cache-Control': 'no-cache'})
        # response = requests.get(url, headers={'Cache-Control': 'no-cache'})
        data = response.text

        print("server_get_moonlight", data)
        return data
    except Exception as e:
        print(e)
        return 0
...
def server_get_version():
    try:
        url = "https://raw.githubusercontent.com/rntkdgnl932/moonlight/master/data_moon/mymodule/version.txt"
